...
open class DefaultWebServiceResponseHandler: WebServiceResponseHandler {
    ...
    fileprivate let successFunction: (_ httpStatusCode: Int, _ responseObject: Any?) -> ()
    ...
    init(
        success: @escaping (_ httpStatusCode: Int, _ responseObject: Any?) -> () = {
            httpStatusCode, responseObject in
        },
    ...
    open func success(_ httpStatusCode: Int, responseObject: Any?) {
        successFunction(httpStatusCode, responseObject)
    }
