...
open class WebServiceHelper {
            ...
            return {
                ...
                case .success(let JSON):
                    ...
                    if 200 ..< 300 ~= statusCode {
                        ...
                        successFunction(webServiceResponse, httpStatusCode: statusCode, responseObject: responseObject, jsonResponse: jsonResponse)
                    }
    ...
    fileprivate static func successFunction(_ webServiceResponse: WebServiceResponseHandler, httpStatusCode: Int,
                                            responseObject: Any! = nil, jsonResponse: String) {
        
        webServiceResponse.success(httpStatusCode, responseObject: responseObject, jsonResponse: jsonResponse)
